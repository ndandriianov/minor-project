...
def seed():
    with app.app_context():
        ...
        app1 = Application(
            ...
            status="interview",
            cover_letter="Хочу пройти стажировку в Mindbox, у меня есть опыт с Python.",
        )
        app2 = Application(
        ...
        news = [
            NewsPost(
                title="Открыт набор на летнюю стажировку в Mindbox",
                body="Mindbox открыл набор на летние стажировки 2026 года для студентов IT-направлений. "
