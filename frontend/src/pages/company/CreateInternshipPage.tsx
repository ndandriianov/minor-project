...
export default function CreateInternshipPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <h1 className="text-2xl font-bold text-gray-900 mb-6">Создать стажировку</h1>
      <p className="text-sm text-gray-500 mb-6">
        После создания стажировка будет отправлена на модерацию и появится в списке после проверки.
      </p>
